  ...
  Chart.Type.extend({
    ...
    initialize:  function(data){
      ...
      helpers.each(data.datasets,function(dataset){
        ...
        this.buildScale(data.labels, dataset.axis, dataset.axisColor, dataset.scaleStartValue, dataset.scaleStepWidth);
    ...
    update : function(){
      ...
      // Reset any highlight colours before updating.
      helpers.each(this.activeElements, function(activeElement){
        activeElement.restore(['fillColor', 'strokeColor', 'pointColor']);
      });
      this.eachPoints(function(point){
        point.save();
      });
    ...
    buildScale : function(labels, axis, axisColor, scaleStartValue, scaleStepWidth){
      var self = this;
      ...
      var scaleOptions = {
        ...
        width : this.chart.width,
        ctx : this.chart.ctx,
        labelsColor : this.options.labelsColor,
        textColor : axisColor || this.options.scaleFontColor,
        fontSize : this.options.scaleFontSize,
        fontStyle : this.options.scaleFontStyle,
        fontFamily : this.options.scaleFontFamily,
        valuesCount : labels.length,
      ...
      if (this.options.scaleOverride){
        var startValue = scaleStartValue || this.options.scaleStartValue
        var scaleSteps = this.options.scaleSteps
        var stepValue = scaleStepWidth || this.options.scaleStepWidth
        ...
        helpers.extend(scaleOptions, {
          ...
          stepValue: stepValue,
          min: startValue,
          max: (startValue + (scaleSteps * stepValue))
        });
      }
